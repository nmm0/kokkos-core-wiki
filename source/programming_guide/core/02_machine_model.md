...
```{figure} https://raw.githubusercontent.com/wiki/kokkos/kokkos/ProgrammingGuide/figures/kokkos-node-doc.png
---
align: center
alt: Conceptual Model of a High Performance Computing Node
---
Conceptual Model of a Future High Performance Computing Node
```
...
[^ang2014]: Ang, J.A., et. al., **Abstract Machine Models and Proxy Architectures for Exascale Computing**,
2014, Sandia National Laboratories and Lawrence Berkeley National Laboratory, DOE Computer Architecture Laboratories Project
